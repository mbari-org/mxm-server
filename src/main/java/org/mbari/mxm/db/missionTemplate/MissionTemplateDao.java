...
public interface MissionTemplateDao {
  ...
  List<MissionTemplate> listMissionTplsDirectory(@Bind("providerId") String providerId,
                                                 @Bind("directory") String directory);
  ...
  MissionTemplate getMissionTemplate(@Bind("providerId") String providerId,
  ...
  @GetGeneratedKeys
  MissionTemplate deleteMissionTemplate(@Bind("providerId") String providerId,
                                        @Bind("missionTplId") String missionTplId);
