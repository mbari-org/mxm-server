...
public class AssetService {
  ...
  public List<Asset> getAllAssets() {
    return dbSupport.getJdbi()
      .withExtension(AssetDao.class, AssetDao::getAllAssets);
  }
  ...
  public Map<String, List<Asset>> getAssetsMultiple(List<String> providerIds) {
    return dbSupport.getJdbi()
      .withExtension(AssetDao.class, dao -> {
        var assets = dao.getAssetsMultiple(providerIds);

        return assets.stream().collect(
          Collectors.groupingBy(Asset::getProviderId, Collectors.toList()));
      });
  }
  ...
  public Asset createAsset(Asset pl) {
    return dbSupport.getJdbi()
      .withExtension(AssetDao.class,
        dao -> dao.insertAsset(pl)
      );
  }
  ...
  public Asset deleteAsset(Asset pl) {
    return dbSupport.getJdbi()
      .withExtension(AssetDao.class,
        dao -> dao.deleteAsset(pl.providerId, pl.assetId)
      );
  }
