...
public class MissionService {
  ...
  @Getter
  private final Broadcaster<Mission> broadcaster = new Broadcaster<>() {
    @Override
  ...
  public List<Mission> getAllMissions() {
    return dbSupport.getJdbi()
      .withExtension(MissionDao.class, MissionDao::getAllMissions);
  }
  ...
  public Mission getMission(String providerId, String missionTplId, String missionId) {
    return dbSupport.getJdbi()
      .withExtension(MissionDao.class, dao -> dao.getMission(providerId, missionTplId, missionId));
  }

  public Mission createMission(Mission pl) {
    var res = dbSupport.getJdbi()
      .withExtension(MissionDao.class, dao -> dao.insertMission(pl));
  ...
  private Mission doUpdate(Mission pl) {
    var uDef = DbUtl.updateDef("missions", pl)
      .where("providerId")
      .where("missionTplId")
      .where("missionId")
  ...
  public Mission deleteMission(Mission pl) {
    var res = dbSupport.getJdbi()
      .withExtension(MissionDao.class,
