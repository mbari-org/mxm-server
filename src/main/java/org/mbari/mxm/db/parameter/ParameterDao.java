...
public interface ParameterDao {
  ...
  List<Parameter> getParameters(@Bind("providerId") String providerId,
  ...
  Parameter getParameter(@Bind("providerId") String providerId,
                         @Bind("missionTplId") String missionTplId,
  ...
  @GetGeneratedKeys
  Parameter deleteParameter(@Bind("providerId") String providerId,
                            @Bind("missionTplId") String missionTplId,
                            @Bind("paramName") String paramName);
